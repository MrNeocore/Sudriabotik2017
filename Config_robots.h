...
#define _Pi                             3.14159265359
    ...
    /****************************** ODOMETRIE *********************************/
    /**************************************************************************/
    #define _ENTRAXE_MM                  296.197 //308.2     //Pas assez tourné -> augmenter entraxe
    #define _DIAMETRE_ROUE_CODEUSE       51.971
    ...
    #define _VITESSE_CONSIGNE_MAX_MM     3.3 //3.3

    #define _VITESSE_DISTANCE_MIN        0.5
    #define _VITESSE_MAX_MM_TENSION      6. //6.
    #define _DISTANCE_CONSIGNE_MM        500.  

    #define _ACC_POSITION_CONSIGNE       2.8
    #define _DCC_POSITION_CONSIGNE       2.8 
    ...
    #define _VITESSE_ANGLE_MAX           0.007 //0.02
    #define _VITESSE_ANGLE_MIN           0.005
    #define _ORIENTATION_CONSIGNE_DEG    90.

    #define _ACC_ORIENTATION_CONSIGNE    6. //4.
    ...
    #define _MAX_ERREUR_INTEGRALLE_V     7500.
    ...
    //PID
    #define _VITESSE_DIS_KP              0.5  //0.25
    #define _VITESSE_DIS_KI              0.02 //0.013
    #define _VITESSE_DIS_KD              0.35 //0.2
    ...
    #define KP_BRAKE                    0.10 //0.09
    #define KI_BRAKE                    0.0004 //0.0015
    ...
    #define _CAPT_ADV_AVANT_G           CAPTEUR1            
    #define _CAPT_ADV_AVANT_D           AUCUN
    #define _CAPT_ADV_AVANT_C           AUCUN

    #define _ETAT_ADV_AVANT_G           ETAT_BAS   // ou état bas (par défault))
    #define _ETAT_ADV_AVANT_D           ETAT_HAUT    //ETAT_HAUT
    ...
    #define _ENTRAXE_MM                  170.400

    //extern double __ENTRAXE_MM;
    //__ENTRAXE_MM = 174.85;
    #define _DIAMETRE_ROUE_CODEUSE       0. //51.9715     //Toujours dans le sens de l'erreur : aler plus loin = diminuer D
    #define _PERIMETRE_ROUE_MM           ( 194.650) //( 194.455 )


    //+COEF_D -> + a droite
    #define  _COEF_D                    (double) 1.0005  //346  //1.00372
    #define  _COEF_G                    (double) 1.001575//1.002175

    /**************************************************************************/
    /******************************** ASSERV **********************************/
    /**************************************************************************/
        //Association distance - Vitesse - Accélérations max
    #define _VITESSE_CONSIGNE_MAX_MM     2.5 //2.8 
    #define _VITESSE_DISTANCE_MIN        0.6
    #define _VITESSE_MAX_MM_TENSION      5.85
    #define _DISTANCE_CONSIGNE_MM        500.
    
    #define _ACC_POSITION_CONSIGNE       2.2 //2.5p
    #define _DCC_POSITION_CONSIGNE       2.92 //2.8
    #define _ACC_POSITION_MIN            0.25 //1.
    #define _DCC_POSITION_MIN            0.30 //1.

    #define _COEF_FREINAGE               0.97

        //Association Angle - Vitesse - Accélérations max
    #define _VITESSE_ANGLE_MAX           0.01 
    #define _VITESSE_ANGLE_MIN           0.002
    #define _ORIENTATION_CONSIGNE_DEG    90.
    ...
    //PID
    #define _VITESSE_DIS_KP              0.5  // 0.9 
    #define _VITESSE_DIS_KI              0.02 //0.50
    #define _VITESSE_DIS_KD              0.35
    ...
    #define CAPT_US_AV_DROIT            CAPTEUR1
    #define CAPT_US_AV_GAUCHE           CAPTEUR2
    #define CAPT_IR_AV_CENTRE           CAPTEUR4
    #define CAPT_IR_AV_GAUCHE           CAPTEUR5
    #define CAPT_IR_AV_DROIT            CAPTEUR6
