...
//        orienter(90, 100);
    ...
    if (COULEUR == BLEU) {
        ...
        orienter(150, 100);
        pompes(POMPE_GAUCHE, ON);
        avancer_reculer(110, vitesse_std); // à régler
        ...
        orienter(155, 100);
        pompes(POMPE_GAUCHE, ON);
        avancer_reculer(160, vitesse_std); // à régler
        ...
        pompes(POMPE_DROITE, ON);
        orienter(180, 100);
        avancer_reculer(900, vitesse_std); // à régler
        ...
        pompes(POMPE_DROITE, ON);
        orienter(180, 100);
        avancer_reculer(135, vitesse_std); // à régler
        avancer_reculer(-145, vitesse_std);
        angle_AX12(4, 660, 80, SANS_ATTENTE); // droite prep depose module
